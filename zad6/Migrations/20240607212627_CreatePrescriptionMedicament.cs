...
{
    /// <inheritdoc />
    public partial class CreatePrescriptionMedicament : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDate = table.Column<DateTime>(type: "timestamp with time zone", maxLength: 100, nullable: false),
                    DoctorIdDoctor = table.Column<int>(type: "integer", nullable: false),
                    PatientIdPatient = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
